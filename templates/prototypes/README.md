...
- `delivery-prototype-notes.template.md` — notes for the feature-level development handoff prototype
...
7. Only after that derive the feature-level `delivery-prototype/*` artifacts.
...
- The common feature prototype is the visual source for the development handoff prototype.
- The delivery prototype is the only place where frontend-facing explanatory comments and implementation hints belong.
