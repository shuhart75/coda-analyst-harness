...
| `требования готовы к объединению` | `requirements` | Проверить требования и отправить рабочую ветку для принятия человеком без создания пакета. |
...
| `требования готовы к объединению` | `отправь требования на проверку`, `подготовь требования к слиянию`, `отправь ветку на слияние` |
