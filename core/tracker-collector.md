...
4. Для обоих провайдеров используй полный JSON-файл, созданный самим MCP-инструментом. Не
   ...
   Не копируй и не перемещай этот файл внутрь корня tracker-run. Если там появился
   незарегистрированный файл или каталог, не удаляй, не переименовывай и не выноси
   его ради повторной проверки: немедленно верни ошибку.
...
только ошибочный status, `job_id`, `run_id` и доступные диагностические пути.
